function addition_function() { // defining addition function
    ...
    document.getElementById("math").innerHTML = "2 + 2 = " + addition; // tell html to print answer
}

function subtraction_function() { // defining subtraction function
    var subtraction = 8 - 4; //what the variable will subtract
    document.getElementById("math").innerHTML = "8 - 4 = " + subtraction; //tell html to print answer
}

function multiplication() { //define multiplication function
    var simple_Math  = 4 * 6; //telling variable to perform 4 * 6
    document.getElementById("math").innerHTML = "4 * 6 = " + simple_Math; //tell html to print answer
}

function division() { //define division function
    var simple_Math = 25 / 5; //variable will perform 25/5
    document.getElementById("math").innerHTML = "25 / 5 = " + simple_Math; //tell html to print answer
}
...
function modulus_Operator() { //define remainder operator function
    ...
    document.getElementById("math").innerHTML = "25 divided by 6 has a remainder of: " + simple_Math; //display result in html
}

function negation_Operator() { //define negation operator function
    var x = 10; //define variable
    document.getElementById("math").innerHTML = -x; //tell variable to negate itself and display in html
}
